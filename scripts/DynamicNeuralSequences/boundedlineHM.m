function varargout = boundedlineHM(varargin)
...
%     end
    ...
    [xp{iln}, yp{iln}] = calcpatch(plotdata{iln,1}, plotdata{iln,2}, isvert, plotdata{iln,6}(iln,:), plotdata{iln,7}(iln,:), nanflag);
