...
[xc,yc,zc]=cylinder(W,N); % The original function allowed you to specify N(=3) to generate a tube, and the radius(=0.01) was =1.
...
p=patch('Vertices',vertices,'Faces',faces,'FaceVertexCData',fc,'FaceColor','interp','FaceLighting','phong','EdgeLighting','phong');
  set(p,'EdgeColor','interp','LineWidth',W,'EdgeLighting','phong','FaceLighting','phong');
