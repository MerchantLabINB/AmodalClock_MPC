function AUC = computedwellAmplitude(params,Manifold)
...
[portionArea_dwell{cModality},TotalArea_dwell{cModality},PeaktoPeak_Amp{cModality},dwell_segment{cModality}] = getAUC(Manifold.AmplitudeTrials,binss,cModality,sp);
end
